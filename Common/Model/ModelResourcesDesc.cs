...
{	
	...
	public class ModelResourcesDesc
	{
		...
		{			
			...
			notSettablePropertyIds.Add(ModelCode.CNODECONTAINER);
			notSettablePropertyIds.Add(ModelCode.EQUIPMENT);
            notSettablePropertyIds.Add(ModelCode.CONDEQ);
			notSettablePropertyIds.Add(ModelCode.REGULATINGCONDEQ);
			notSettablePropertyIds.Add(ModelCode.MEASUREMENTVALUE);
			notSettablePropertyIds.Add(ModelCode.ROTATINGMACHINE);
			notSettablePropertyIds.Add(ModelCode.PSR);
		}
